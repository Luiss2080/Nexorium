...
class Perfil extends Model {
    ...
    protected $fillable = [
        'usuario_id', 'biografia', 'especialidades', 'experiencia', 'educacion',
        'certificaciones', 'linkedin', 'website', 'telefono_alternativo', 
        'direccion_completa', 'ciudad', 'pais', 'fecha_nacimiento', 'genero'
    ];
    ...
    private function calcularCompletitud($usuario) {
        $campos = [
            ...
            'biografia', 'fecha_nacimiento', 'avatar'
        ];
