...
class Inscripcion extends Model {
    ...
    protected $fillable = [
        'usuario_id', 'curso_id', 'fecha_inscripcion', 'estado', 'nota_final', 'certificado'
    ];
    ...
    public function obtenerEstadisticas($usuarioId = null, $cursoId = null) {
        ...
        return [
            'total' => $this->db->fetch(
                "SELECT COUNT(*) as count FROM inscripciones $whereClause", $params
            )['count'],
    ...
    public function completarCurso($usuarioId, $cursoId, $notaFinal = null) {
        ...
        return $this->db->execute(
            ...
            [$data['estado'], $data['fecha_completacion'], $data['nota_final'] ?? null, 
             $data['certificado'] ?? null, $usuarioId, $cursoId]
        );
    }
